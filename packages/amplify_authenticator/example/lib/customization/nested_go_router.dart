...
class NestedGoRouter extends StatelessWidget {
  NestedGoRouter({Key? key}) : super(key: key);
    ...
    routes: <GoRoute>[
      GoRoute(
        ...
        builder: (context, state) {
          ...
          return AuthenticatorRouter.fromRouterConfig(
            config: goRouter,
          );
        },
      ),
        ...
        child: Center(
          child: Column(
            children: [
              ...
              const SizedBox(height: 32),
              SignOutButton(
                onSignOut: (() => GoRouter.of(context).go('/auth/sign-in')),
              ),
            ],
          ),
        ),
